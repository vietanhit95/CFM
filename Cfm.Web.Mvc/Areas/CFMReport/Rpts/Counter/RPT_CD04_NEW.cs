...
namespace Cfm.Web.Mvc.Areas.CFMReport.Rpts.Counter {
    ...
    public class RPT_CD04_NEW : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "Cfm.Web.Mvc.Areas.CFMReport.Rpts.Counter.RPT_CD04_NEW.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedRPT_CD04_NEW : Component, ICachedReport {
        
        public CachedRPT_CD04_NEW() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            RPT_CD04_NEW rpt = new RPT_CD04_NEW();
            rpt.Site = this.Site;
            return rpt;
        }
