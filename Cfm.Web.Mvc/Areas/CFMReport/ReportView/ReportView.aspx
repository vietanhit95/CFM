<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReportView.aspx.cs" Inherits="Cfm.Web.Mvc.Areas.CFMReport.ReportView.ReportView" %>
                        ...
                        <td>
                            <div>
                                <CR:CrystalReportViewer ID="crvReport" runat="server" AutoDataBind="true" HasCrystalLogo="False"
                                        Height="50px" Width="350px" style="margin:auto; padding:inherit;" HasDrilldownTabs="False" EnableTheming="True" HasToggleGroupTreeButton="False" HasToggleParameterPanelButton="False" SeparatePages="False" ShowAllPageIds="True" ToolPanelView="None" EnableDrillDown="False" HasDrillUpButton="False" HasExportButton="False" HasPrintButton="False" PageZoomFactor="150"/>
                            </div>
                        </td>
                    </tr>
                </table>
