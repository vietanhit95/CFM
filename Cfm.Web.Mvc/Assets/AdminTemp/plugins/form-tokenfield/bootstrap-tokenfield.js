  ...
  , createToken: function (attrs, triggerChange) {
      ...
      if (!this.maxTokenWidth) {
        this.maxTokenWidth =
          ...
          parseInt($closeButton.css('margin-left'), 5) -
          parseInt($closeButton.css('margin-right'), 5) -
          parseInt($token.css('border-left-width'), 5) -
          parseInt($token.css('border-right-width'), 5) -
          parseInt($token.css('padding-left'), 5) -
          parseInt($token.css('padding-right'), 5)
          parseInt($tokenLabel.css('border-left-width'), 5) -
          parseInt($tokenLabel.css('border-right-width'), 5) -
          parseInt($tokenLabel.css('padding-left'), 5) -
          parseInt($tokenLabel.css('padding-right'), 5)
          parseInt($tokenLabel.css('margin-left'), 5) -
          parseInt($tokenLabel.css('margin-right'), 5)
      }

      $tokenLabel.css('max-width', this.maxTokenWidth)
      //$tokenLabel.css('max-width', 120)
